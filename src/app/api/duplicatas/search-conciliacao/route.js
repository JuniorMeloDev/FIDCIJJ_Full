...
export async function GET(request) {
    try {
        ...
        let dbQuery = supabase
            .from('duplicatas')
            .select('*, operacao:operacoes!inner(status, cliente_id, data_operacao, valor_liquido, valor_total_bruto, valor_total_juros, valor_total_descontos, juros_pre_fixado, tipo_operacao:tipos_operacao(juros_pre_fixado))')
