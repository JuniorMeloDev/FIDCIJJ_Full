...
export default function LancamentoModal({ isOpen, onClose, onSave, contasMaster, clienteMasterNome }) {
    ...
    const handleLimpar = () => {
        ...
        setContaDestino('');
        setError('');
        setIsDespesa(true); // Reseta o checkbox
    };
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            isDespesa: tipo === 'DEBITO' ? isDespesa : null, // Envia o estado do checkbox
        };
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50" onClick={onClose}>
            <div className="bg-gray-800 text-white p-6 rounded-lg shadow-xl w-full max-w-lg" onClick={e => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {/* Checkbox de Despesa que aparece apenas para Débito */}
                    { tipo === 'DEBITO' && (
                        <div className="pt-2">
                            <label className="flex items-center">
                                ...
                                />
                                <span className="ml-2 text-sm text-gray-200">É uma despesa? (Marque para contar no resumo de despesas)</span>
                            </label>
                        </div>
                    )}
