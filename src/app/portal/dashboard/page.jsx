...
const MinhasOperacoesView = ({ operacoes, duplicatas, kpis, loading, error }) => {
    ...
    const currentOperacoes = operacoes.slice(indexOfFirstItem, indexOfLastItem);
    ...
    return (
        <>
            ...
            {/* Tabela de Acompanhamento de Duplicatas */}
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg mb-8">
...
const NovaOperacaoView = () => {
    // A lógica da sua página /portal/enviar-operacao pode ser movida para cá no futuro
    return (
